...
import img1 from '../../assets/images/mer1.png';
// import img2 from '../../assets/images/mer6.png';
// import img3 from '../../assets/images/mer4.png';
// import img4 from '../../assets/images/mer5.png';

import './menuclassic.css';
export default class Menuclassic extends Component {
  render() {
    const settings = {
      dots: true,
      infinite: true,
